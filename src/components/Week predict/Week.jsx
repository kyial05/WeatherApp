...
import "../This day/styles/Week.css";

export const WeekPredict = ({ active, setActive, children }) => {
  return (
    <div
      className={active ? "modalWeek active" : "modalWeek"}
...
//   // api
//   const src2 = `https://api.openweathermap.org/data/2.5/forecast?q=karakol&appid=66438398e5bd0e58da592a51b7a2dd7b`;

//   useEffect(() => {
//     axios.get(src2).then((data) => {
//       setWeekInfo(data.data.list[0].main.temp);
//       // console.log(current);
//     });
//   });
...
//       date: monthDate1,
//       img: cloudy,
//       tempDay: "+" + Math.round(weekInfo - 273.15) + "°",
//       tempNight: "+" + 19 + "°",
//       weatherDes: "Облачно",
//     },
//     {
